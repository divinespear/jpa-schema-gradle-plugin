...
class GenerateSqlServerSpec extends IntegrationSpec {
    ...
    def shouldWorkEclipseLink() {
        ...
        file("build/generated-schema/mssqlscript-create.sql").text == """CREATE TABLE KEY_VALUE_STORE (STORED_KEY VARCHAR(128) NOT NULL, CREATED_AT DATETIME2 NULL, STORED_VALUE VARCHAR(32768) NULL, PRIMARY KEY (STORED_KEY));
