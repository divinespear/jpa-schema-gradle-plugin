...
class GenerateMySQLSpec extends FunctionalSpec {
    ...
    def shouldWorkEclipseLink() {
        ...
        file("build/generated-schema/create.sql").text == """CREATE TABLE KEY_VALUE_STORE (STORED_KEY VARCHAR(128) NOT NULL, CREATED_AT DATETIME, STORED_VALUE VARCHAR(32768), PRIMARY KEY (STORED_KEY));
